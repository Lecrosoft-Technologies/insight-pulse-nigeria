  ...
  const services = [
    {
      ...
      description:
        "Measure satisfaction across the entire customer journey from pre-purchase to after-sales service.",
      features: [
        "Dealer satisfaction",
    ...
    },
    {
      ...
      description:
        "Understand how consumers use their vehicles and what drives their automotive choices.",
      features: [
    ...
    },
    {
      ...
      description:
        "Track market share, brand performance, and competitive positioning in the automotive sector.",
      features: [
        "Brand tracking",
    ...
    },
    {
      ...
      description:
        "Test new vehicle concepts, features, and innovations before market launch.",
      features: [
        "Concept testing",
  ...
  const insights = [
    {
      ...
      description:
        "The Nigerian automotive market is experiencing significant growth with increasing vehicle ownership.",
      stat: "15%",
    ...
    },
    {
      ...
      description:
        "Growing interest in electric vehicles among urban Nigerian consumers, especially in Lagos.",
      stat: "28%",
    ...
    },
    {
      ...
      description:
        "Quality after-sales service is the top factor influencing brand loyalty in Nigeria.",
      stat: "73%",
  ...
  const caseStudies = [
    {
      ...
      challenge:
        "Understanding brand perception and customer journey in Nigeria",
      solution:
        "Comprehensive customer satisfaction and brand tracking study across 6 states",
      results: [
        "45% improvement in customer satisfaction",
        "25% increase in brand awareness",
        "New service center strategy",
      ],
    },
    {
            ...
            <ScrollReveal>
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                  Navigate the dynamic automotive landscape in Nigeria and West
                  Africa with insights that fuel growth, enhance customer
                  satisfaction, and accelerate market penetration.
                </p>
            ...
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Comprehensive research solutions tailored for the automotive
          ...
          <div className="container mx-auto px-4">
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Key findings from our latest automotive research in Nigeria
                  and West Africa
                </p>
              </div>
            </ScrollReveal>
          ...
          <div className="container mx-auto px-4">
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Real results from our automotive research projects across
            ...
            <ScrollReveal>
              <div className="max-w-3xl mx-auto">
                ...
                <p className="text-lg mb-8 text-background/90">
                  Get actionable insights that drive automotive success in
                  Nigeria and West Africa. Partner with PSI for research
                  excellence.
                </p>
                <Button
                  variant="outline"
