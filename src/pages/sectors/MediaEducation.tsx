...
import { ArrowRight, BookOpen, Radio, Tv, GraduationCap, TrendingUp, Users } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Track audience behavior, media preferences, and content consumption patterns across TV, radio, digital, and print media."
    },
    {
      icon: Radio,
      title: "Advertising Effectiveness",
      description: "Measure ad recall, brand lift, and campaign ROI across multiple media channels and platforms."
    },
    {
      icon: GraduationCap,
      title: "Education Market Research",
      description: "Student enrollment trends, parent preferences, learning outcomes assessment, and institutional reputation studies."
    },
    {
      icon: Users,
      title: "Audience Measurement",
      description: "Comprehensive audience analytics including demographics, psychographics, and viewing/listening habits."
    },
    {
      icon: TrendingUp,
      title: "Content Performance Analysis",
      description: "Evaluate content effectiveness, audience engagement, and programming strategies for media companies."
    },
    {
      icon: BookOpen,
      title: "EdTech & E-Learning Research",
      description: "Digital learning adoption, online education platforms, and technology integration in educational institutions."
    }
  ];
  ...
  const caseStudies = [
    {
      ...
      challenge: "Major broadcasting network needed to understand changing viewer preferences and optimize programming schedule",
      solution: "Conducted comprehensive audience measurement study with 10,000+ respondents across Nigeria, analyzing viewing patterns and content preferences",
      result: "Programming adjustments led to 25% increase in prime-time viewership and improved advertiser confidence"
    },
    {
      title: "Private University Market Positioning",
      challenge: "New private university required market entry strategy and brand positioning in competitive education landscape",
      solution: "Multi-phase research including parent surveys, student focus groups, and competitive analysis across 5 states",
      result: "Strategic positioning led to 150% enrollment target achievement in first academic year"
    }
  ];
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl lg:text-2xl mb-8 text-primary-foreground/90">
                Strategic insights for media companies and educational institutions across Nigeria and West Africa
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                From audience measurement to educational market trends, we provide the insights that drive success in media and education sectors
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
              Partner with Nigeria's trusted research experts for actionable insights in media and education sectors.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
