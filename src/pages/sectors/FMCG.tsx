  ...
  const services = [
    {
      ...
      description:
        "Monitor brand performance, awareness, and consumer perception across key FMCG categories.",
    },
    {
      icon: TrendingUp,
      title: "Market Share Analysis",
      description:
        "Comprehensive market share studies with competitive landscape analysis and growth opportunities.",
    },
    {
      icon: Users,
      title: "Consumer Behavior Studies",
      description:
        "Deep-dive into consumer purchase drivers, shopping habits, and brand loyalty patterns.",
    },
    {
      icon: BarChart3,
      title: "Retail Audit & Distribution",
      description:
        "Track product availability, pricing, promotion effectiveness, and shelf visibility.",
    },
    {
      icon: Target,
      title: "Product Launch Research",
      description:
        "Pre-launch testing, concept validation, and post-launch performance tracking.",
    },
    {
      icon: Zap,
      title: "Price Sensitivity Analysis",
      description:
        "Optimize pricing strategies through elasticity studies and competitive price tracking.",
    },
  ];
  ...
  const caseStudies = [
    {
      ...
      challenge:
        "A global beverage company needed to understand Nigerian consumer preferences for a new product category",
      solution:
        "Conducted nationwide consumer research with 5,000+ interviews across urban and rural markets",
      result:
        "Successful product launch with 15% market share in year one, exceeding projections by 40%",
    },
    {
      title: "Personal Care Market Entry",
      challenge:
        "International cosmetics brand required market entry strategy for Nigerian women",
      solution:
        "Multi-phase research including cultural insights, beauty routines analysis, and competitive positioning",
      result:
        "Strategic positioning led to #3 market position within 18 months",
    },
  ];
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl lg:text-2xl mb-8 text-muted-foreground leading-relaxed">
                Deep consumer insights for fast-moving consumer goods across
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                From brand health to retail execution, we provide the insights
                you need to succeed in competitive FMCG markets
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Specialized expertise across all major fast-moving consumer
                goods categories
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-muted-foreground  mb-8 max-w-2xl mx-auto">
              Partner with Nigeria's leading FMCG research specialists. Get
