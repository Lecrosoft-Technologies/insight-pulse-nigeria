  ...
  const services = [
    {
      ...
      description: "Measure and improve customer satisfaction across all touchpoints in the telecoms journey.",
      features: ["Net Promoter Score tracking", "Service quality assessment", "Churn analysis", "Customer journey mapping"]
    },
    {
      icon: <Network className="h-8 w-8" />,
      title: "Network Quality Studies",
      description: "Assess network performance perception and identify areas for infrastructure improvement.",
      features: ["Coverage satisfaction", "Speed perception studies", "Quality benchmarking", "Service reliability tracking"]
    },
    {
      icon: <TrendingUp className="h-8 w-8" />,
      title: "Market Share Analysis",
      description: "Track competitive positioning and market dynamics in the telecommunications sector.",
      features: ["Brand penetration tracking", "Competitor analysis", "Market share monitoring", "Usage pattern analysis"]
    },
    {
      icon: <Target className="h-8 w-8" />,
      title: "Product Launch Research",
      description: "Support successful launches of new telecoms services and products with market insights.",
      features: ["Concept testing", "Pricing optimization", "Feature prioritization", "Launch impact measurement"]
    }
  ];
  ...
  const insights = [
    {
      ...
      description: "Nigeria has one of the highest mobile penetration rates in West Africa with continued growth.",
      stat: "104%",
      label: "Mobile Penetration"
    },
    {
      title: "Internet Usage Growth",
      description: "Rapid increase in internet usage driven by smartphone adoption and improved network coverage.",
      stat: "85%",
      label: "Internet Users"
    },
    {
      title: "Data Service Priority",
      description: "Data services have become the primary revenue driver for telecoms operators in Nigeria.",
      stat: "67%",
  ...
  const caseStudies = [
    {
      ...
      solution: "Comprehensive customer satisfaction and churn analysis across all service touchpoints",
      results: ["35% reduction in customer churn", "Improved customer satisfaction by 40%", "New retention strategy implemented"]
    },
    {
      client: "Regional Network Provider",
      challenge: "Launching 5G services in competitive Nigerian market",
      solution: "Market readiness assessment and pricing strategy optimization study",
      results: ["Optimal 5G pricing identified", "Target segments prioritized", "25% faster market adoption"]
    }
  ];
            ...
            <ScrollReveal>
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                  Navigate Nigeria's rapidly evolving telecommunications landscape with research 
                  that drives network excellence, customer satisfaction, and market leadership.
                </p>
            ...
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Comprehensive research solutions for telecommunications companies in Nigeria and West Africa
                </p>
              </div>
            </ScrollReveal>
          ...
          <div className="container mx-auto px-4">
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Latest statistics and trends from Nigeria's telecommunications industry
                </p>
              </div>
            </ScrollReveal>
          ...
          <div className="container mx-auto px-4">
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  How our research has helped telecoms companies achieve their goals in Nigeria
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
              <div className="max-w-3xl mx-auto">
                ...
                <p className="text-lg mb-8 text-background/90">
                  Get the insights you need to thrive in Nigeria's competitive telecoms market. 
                  Partner with PSI for research that drives digital success.
                </p>
