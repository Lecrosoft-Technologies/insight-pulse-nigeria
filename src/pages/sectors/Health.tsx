...
import { ArrowRight, Heart, Shield, Stethoscope, Pill, Users, TrendingUp } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Understanding patient journeys, satisfaction levels, and healthcare service quality improvements."
    },
    {
      icon: Shield,
      title: "Health Insurance Studies",
      description: "Market research for health insurance products, coverage preferences, and enrollment barriers."
    },
    {
      icon: Stethoscope,
      title: "Healthcare Provider Research",
      description: "Physician and hospital studies, medical practice insights, and healthcare professional surveys."
    },
    {
      icon: Pill,
      title: "Pharmaceutical Market Research",
      description: "Drug efficacy studies, patient compliance research, and pharmaceutical market analysis."
    },
    {
      icon: Users,
      title: "Public Health Studies",
      description: "Community health assessments, disease awareness campaigns, and health behavior research."
    },
    {
      icon: TrendingUp,
      title: "Health Technology Research",
      description: "Digital health adoption, telemedicine usage, and health app user experience studies."
    }
  ];
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl lg:text-2xl mb-8 text-primary-foreground/90">
                Evidence-based healthcare insights for better health outcomes across Nigeria and West Africa
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Comprehensive research solutions for healthcare providers, pharmaceutical companies, and health organizations
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Specialized expertise across all areas of healthcare and pharmaceutical industries
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl lg:text-6xl font-bold text-primary mb-4">100+</div>
                <p className="text-xl text-muted-foreground">Healthcare Studies</p>
              </div>
              <div className="text-center">
                <div className="text-4xl lg:text-6xl font-bold text-accent mb-4">500K+</div>
                <p className="text-xl text-muted-foreground">Patients Surveyed</p>
              </div>
              <div className="text-center">
                <div className="text-4xl lg:text-6xl font-bold text-primary mb-4">50+</div>
                <p className="text-xl text-muted-foreground">Healthcare Partners</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
              Partner with Nigeria's leading healthcare research specialists. Drive better health outcomes with data-driven insights.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
