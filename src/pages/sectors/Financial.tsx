...
import { ArrowRight, CreditCard, PieChart, Shield, Smartphone, TrendingUp, Users } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Customer satisfaction, product development, and market penetration studies for banking services."
    },
    {
      icon: PieChart,
      title: "Investment & Wealth Management",
      description: "Investor behavior analysis, product preference studies, and wealth management insights."
    },
    {
      icon: Shield,
      title: "Insurance Market Research",
      description: "Claims experience studies, product development, and customer retention analysis."
    },
    {
      icon: Smartphone,
      title: "Fintech & Digital Banking",
      description: "User experience research, adoption studies, and digital transformation insights."
    },
    {
      icon: TrendingUp,
      title: "Financial Inclusion Studies",
      description: "Unbanked population research, microfinance studies, and financial literacy assessments."
    },
    {
      icon: Users,
      title: "Customer Experience Research",
      description: "Journey mapping, satisfaction studies, and service quality improvement research."
    }
  ];
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl lg:text-2xl mb-8 text-primary-foreground/90">
                Trusted insights for banks, insurance companies, and fintech innovators across Africa
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                From traditional banking to cutting-edge fintech, we provide the insights that drive financial innovation
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-xl text-muted-foreground">Financial Institutions Served</p>
              </div>
              <div className="text-center">
                <div className="text-4xl lg:text-6xl font-bold text-accent mb-4">2M+</div>
                <p className="text-xl text-muted-foreground">Banking Customers Surveyed</p>
              </div>
              <div className="text-center">
                <div className="text-4xl lg:text-6xl font-bold text-primary mb-4">100+</div>
                <p className="text-xl text-muted-foreground">Financial Products Tested</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
              Partner with Nigeria's trusted financial services research experts. Get insights that transform your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
