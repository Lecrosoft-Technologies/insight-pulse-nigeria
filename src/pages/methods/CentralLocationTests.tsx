  ...
  const advantages = [
    {
      ...
      description: "Standardized testing conditions ensure consistent and reliable results across all participants.",
      features: ["Standardized setup", "Controlled variables", "Professional facilities", "Reduced bias"]
    },
    {
      icon: <Eye className="h-8 w-8" />,
      title: "Direct Observation",
      description: "Real-time observation of consumer behavior and reactions to products or concepts.",
      features: ["Behavioral insights", "Emotional responses", "Usage patterns", "Interaction analysis"]
    },
    {
      icon: <Settings className="h-8 w-8" />,
      title: "Versatile Testing",
      description: "Suitable for various research objectives from product testing to concept evaluation.",
      features: ["Product trials", "Taste testing", "Concept evaluation", "Packaging assessment"]
    },
    {
      icon: <Clock className="h-8 w-8" />,
      title: "Time Efficient",
      description: "Conduct multiple tests simultaneously with faster data collection and immediate feedback.",
      features: ["Rapid execution", "Immediate results", "Multiple sessions", "Quick turnaround"]
    }
  ];
  ...
  const applications = [
    {
      ...
      description: "Product trials for food, beverages, personal care, and household products.",
      examples: ["New product taste tests", "Packaging preferences", "Brand comparisons", "Usage trials"]
    },
    {
      category: "Concept Testing",
      description: "Evaluate new product concepts, advertising materials, and brand positioning.",
      examples: ["Ad concept testing", "Brand positioning", "Campaign evaluation", "Message testing"]
    },
    {
      category: "Sensory Research",
      description: "Detailed sensory analysis using controlled testing environments.",
      examples: ["Taste profiling", "Texture analysis", "Aroma testing", "Visual assessment"]
    },
    {
      category: "Technology Testing",
      description: "User experience testing for digital products and applications.",
      examples: ["App usability", "Website navigation", "Interface design", "Feature testing"]
    }
  ];
  ...
  const process = [
    {
      step: "1",
      title: "Study Design",
      description: "Define objectives, target audience, and testing methodology"
    },
    {
      step: "2", 
    ...
    },
    {
      step: "3",
      title: "Recruitment",
      description: "Screen and recruit qualified participants matching target profile"
    },
    {
      step: "4",
      title: "Testing Sessions",
      description: "Conduct structured testing sessions with direct observation"
    },
    {
      step: "5",
      title: "Data Analysis",
    ...
    },
    {
      step: "6",
      title: "Reporting",
      description: "Deliver comprehensive findings with actionable recommendations"
    }
  ];
            ...
            <ScrollReveal>
              <div className="max-w-4xl mx-auto text-center">
                ...
                <h1 className="text-4xl lg:text-6xl font-bold mb-6">
                  ...
                  <span className="block text-accent-glow"> for Precise Insights</span>
                </h1>
                <p className="text-xl lg:text-2xl mb-8 text-primary-foreground/90">
                  Conduct controlled product testing and concept evaluation in professional 
            ...
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  CLT provides controlled, standardized environments for reliable consumer research
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
              <div className="max-w-3xl mx-auto">
                ...
                <p className="text-lg mb-8 text-primary-foreground/90">
                  Get precise consumer insights through our professional Central Location Testing services. 
                  Contact PSI today to design your perfect study.
                </p>
