  ...
  const features = [
    {
      ...
      description:
        "Skilled moderators who facilitate productive discussions and extract deep insights from participants.",
    },
    {
      icon: MessageSquare,
      title: "In-Depth Discussions",
      description:
        "Comprehensive group discussions that uncover attitudes, perceptions, and motivations behind consumer behavior.",
    },
    {
      icon: Eye,
      title: "Client Observation",
      description:
        "One-way mirror viewing rooms and live streaming options for real-time client observation.",
    },
    {
      icon: Mic,
      title: "Professional Recording",
      description:
        "High-quality audio and video recording for detailed analysis and reporting.",
    },
    {
      icon: Camera,
      title: "Modern Facilities",
      description:
        "State-of-the-art focus group facilities in major cities across Nigeria and West Africa.",
    },
    {
      icon: Clock,
      title: "Flexible Scheduling",
      description:
        "Evening, weekend, and customized scheduling to accommodate diverse participant availability.",
    },
  ];
  ...
  const process = [
    {
      ...
      title: "Study Design",
      description:
        "We collaborate with you to define objectives, target segments, and discussion guide development.",
    },
    {
      step: "2",
      title: "Participant Recruitment",
      description:
        "Professional recruitment of qualified participants matching your target demographics and psychographics.",
    },
    {
      step: "3",
      title: "Moderation & Recording",
      description:
        "Expert moderation of group discussions with professional audio/video recording and client observation.",
    },
    {
      step: "4",
      title: "Analysis & Reporting",
      description:
        "Comprehensive analysis of discussions with actionable insights and strategic recommendations.",
    },
  ];
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl lg:text-2xl mb-8 text-muted-foreground leading-relaxed">
                Uncover deep consumer insights through expert-moderated
                qualitative research across Nigeria and West Africa
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Modern facilities, expert moderation, and comprehensive analysis
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Focus groups and IDIs are perfect for understanding the 'why'
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                From concept to insights - a proven methodology for qualitative
                excellence
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-primary text-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Get rich qualitative insights with our expert-moderated focus
