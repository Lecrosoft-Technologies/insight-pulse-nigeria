          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold">Practical Sampling International</h3>
                  <p className="text-primary-foreground/80 text-sm">Market Research Excellence</p>
                </div>
              </div>
              <p className="text-primary-foreground/80 leading-relaxed">
                Practical Sampling International (PSI) is a full-service research agency 
                based in Nigeria with a trusted network across West Africa. We deliver 
                marketing, social and opinion research—from proposal to final insights—so 
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">Lagos, Nigeria (Headquarters)</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="h-5 w-5 flex-shrink-0" />
                <span className="text-sm">+234-XXX-XXXXX</span>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-smooth">
              ...
              <ul className="space-y-1">
                {coverage.map((country) => (
                  <li key={country} className="flex items-center gap-2">
                    ...
                    <span className="text-primary-foreground/80 text-sm">{country}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="mt-16 pt-8 border-t border-primary-foreground/20">
          <div className="max-w-md">
            ...
            <p className="text-primary-foreground/80 text-sm mb-4">
              Subscribe to receive our latest market insights and research reports.
            </p>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-wrap gap-6 text-sm text-primary-foreground/80">
              ...
              <a href="/cookies" className="hover:text-primary-foreground transition-smooth">
                Cookie Policy
              </a>
              <a href="/sitemap.xml" className="hover:text-primary-foreground transition-smooth">
                Sitemap
              </a>
            </div>
      ...
      <div className="bg-accent text-accent-foreground">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <h5 className="font-semibold mb-1">Ready to commission a study?</h5>
              <p className="text-accent-foreground/90 text-sm">Get a custom proposal in 24 hours</p>
            </div>
