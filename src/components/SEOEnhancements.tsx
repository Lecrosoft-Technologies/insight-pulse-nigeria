...
export const SEOEnhancements = ({
  ...
  keywords = [
    "The best market research agencies Nigeria",
    "Number 1 market research agencies Nigeria",
    "Number 1 market research firms Nigeria",
    "Top market research Nigeria",
    "Top 10 market research agencies in Nigeria",
    "Top 20 marketing research firms in Nigeria.",
    "Top 10 reliable and trusted marketing research companies in West Africa",
